...
$blog_single_page_paragraph_one = get_field('blog_single_page_paragraph_one');
$blog_single_page_paragrah_two = get_field('blog_single_page_paragrah_two');
$blog_single_page_image = get_field('blog_single_page_image');
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-4">
        <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
          <img class="absolute inset-0 h-full w-full object-cover brightness-125 saturate-0" src="<?php echo $blog_single_page_image; ?>" alt="">
      ...
      <div>
        <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
          ...
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><?php echo get_the_title(); ?></h1>
          <div class="max-w-xl">
            <p class="mt-6"><?php echo $blog_single_page_paragraph_one; ?></p>
            <p class="mt-6"><?php echo $blog_single_page_paragrah_two; ?></p>
          </div>
        </div>
